          ...
          <div className='crawl-text'>
            <div className='text-yellow-300 text-xl leading-relaxed max-w-3xl mx-auto space-y-12 px-8'>
              ...
              <p className='text-3xl'>
                Light pollution, clouds, and urban sprawl have made it harder than ever to see the night sky in all its
                glory.
              </p>
              <p className='text-3xl'>
                But fear not! Our app helps you find the perfect dark sky locations near you for optimal stargazing.
              </p>
              <p className='text-3xl'>
                Discover pristine viewing spots, check real-time conditions, and never miss a celestial event again.
              </p>

              <div className='text-center mt-20'>
                <h1 className='text-7xl font-bold text-yellow-400'>WHERETOSTARGAZE</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='relative z-20 bg-[#1f2230]'>
          <div className='max-w-4xl mx-auto px-8 py-20 text-white'>
            ...
            <div className='space-y-8 text-lg leading-relaxed'>
              <p>
                WhereToStarGaze is your ultimate companion for discovering the perfect locations to experience the wonders of
                the night sky. Whether you're an amateur astronomer, a photography enthusiast, or simply someone who
                appreciates the beauty of the cosmos, we help you find the darkest skies within your reach.
              </p>
              ...
              <div className='grid md:grid-cols-2 gap-8 mt-6'>
                <div className='bg-purple-900/30 p-6 rounded-lg'>
                  ...
                  <p>
                    Enter your location and how far you're willing to travel. Our algorithm analyzes light pollution data,
                    accessibility, and nearby amenities to recommend the best spots.
                  </p>
                </div>
                ...
                <div className='bg-purple-900/30 p-6 rounded-lg'>
                  ...
                  <p>
                    Discover which planets, constellations, and deep-sky objects are visible at your chosen date and time.
                    Plan your observations around the best viewing windows for specific celestial bodies.
                  </p>
                </div>
                ...
                <div className='bg-purple-900/30 p-6 rounded-lg'>
                  ...
                  <p>
                    Discover parks, campgrounds, and designated dark sky areas that offer the best viewing experiences,
                ...
                <div className='bg-purple-900/30 p-6 rounded-lg'>
                  ...
                  <p>
                    Visualize light pollution levels with interactive heatmaps to understand exactly where to find the
                    darkest skies in your area.
                  </p>
                </div>
              </div>
              ...
              <p>
                Over 80% of the world's population lives under light-polluted skies, and one-third of humanity can no longer
                see the Milky Way from their homes. Dark sky locations offer a window into the beauty of the cosmos,
                presenting a canvas of thousands of stars, nebulae, and galaxies. These pristine viewing areas aren't just
                about astronomy; they're about reconnecting with nature and experiencing the profound sense of wonder that
                comes from understanding our place in the universe.
              </p>
